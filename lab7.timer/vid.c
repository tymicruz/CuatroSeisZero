...
int scroll()
{
  ...
  put_word(0, base, offset+(72*2));
  put_word(0, base, offset+(73*2));
  put_word(0, base,offset+(74*2));
  put_word(0, base, offset+(75*2));
  put_word(0, base, offset+(76*2));
  put_word(0, base, offset+(77*2));
  put_word(0, base, offset+(78*2));
  put_word(0, base, offset+(79*2));

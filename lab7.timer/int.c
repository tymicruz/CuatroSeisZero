...
char *cmds[] = {"getpid()", "ps()", "chname()", "kmode()", "tswitch()", "wait(&status)", "exit(value)", "kfork()", "exec(filename)", "pipe()","pfd()", "read_pipe()", "write_pipe()", "close_pipe()", "itimer(time)"};
...
//==> WRITE CODE TO GET get syscall parameters a,b,c,d from ustack 
   ...
   switch(a){
       ...
       case 9 : printf("hello in kernel a: %d cmd: %s\n", a, cmds[a]);r = kpipe(b);          break;
       case 10 : printf("hello in kernel a: %d cmd: %s\n", a, cmds[a]);r = kpfd();          break;
       case 11 : printf("hello in kernel a: %d cmd: %s\n", a, cmds[a]);r = kread_pipe(b,c,d);      break;
       case 12 : printf("hello in kernel a: %d cmd: %s\n", a, cmds[a]);r = kwrite_pipe(b,c,d);          break;
       case 13 : printf("hello in kernel a: %d cmd: %s\n", a, cmds[a]);r = kclose_pipe(b);          break;
       case 14 : printf("hello in kernel a: %d cmd: %s\n", a, cmds[a]);r = itimer(b);          break;
       case 98 : putc(b); break;
